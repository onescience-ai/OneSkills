...
| **资源检索** | 按自然语言需求检索模型、组件、数据管线、数据集、第三方工具、数据库、服务、输出格式、工作流规划等统一科研原语资源，覆盖气象/气候、生信、材料化学、流体力学及跨领域科研方法 |
| **原语蒸馏** | 将 `scientific-agent-skills` 和第三方科研能力蒸馏为 `onescience-primitives` 资产包，保留 provider、provenance、requirements 与契约边界 |
