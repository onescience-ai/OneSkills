...
- `./oneskills/contracts/fuxiembedding.md`
- `./oneskills/contracts/fuxitransformer.md`
- `./oneskills/contracts/fuxidownsample.md`
- `./oneskills/contracts/fuxiupsample.md`
- `./oneskills/contracts/fuxifc.md`
