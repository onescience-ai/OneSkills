...
- `./oneskills/contracts/fengwuencoder.md`
- `./oneskills/contracts/fengwufuser.md`
- `./oneskills/contracts/fengwudecoder.md`
- `./oneskills/contracts/panguembedding.md`
- `./oneskills/contracts/pangudownsample.md`
- `./oneskills/contracts/panguupsample.md`
- `./oneskills/contracts/pangupatchrecovery.md`
