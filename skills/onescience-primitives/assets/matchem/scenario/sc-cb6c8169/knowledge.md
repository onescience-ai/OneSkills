...
## 关联论文
- A physics-informed machine learning framework for accelerated discovery of single-phase B2 multi-principal element intermetallics | doi:
