# 实例任务：结构或电化学响应获取 @ 固态锂离子导体无监督发现

- domain: matchem
- 骨架: matchem-structure-or-electrochemical-response-acquisition-task
- 场景: matchem-solid-state-lithium-ion-conductor-unsupervised-discovery-scenario (固态锂离子导体无监督发现)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 固态锂离子导体无监督发现
- 关联论文: Unsupervised discovery of solid-state lithium ion conductors | doi:
