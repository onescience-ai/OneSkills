# 实例任务：根源模型训练与适用域评估 @ MOF结构力学稳定性机器学习预测

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-mof-mechanical-stability-machine-learning-prediction-scenario (MOF结构力学稳定性机器学习预测)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- MOF结构力学稳定性机器学习预测
- 关联论文: Structure-Mechanical Stability Relations of Metal-Organic Frameworks via Machine Learning | doi:
