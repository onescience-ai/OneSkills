# 实例任务：根源模型训练与适用域评估 @ 有机半导体主动学习发现

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-organic-semiconductor-active-learning-discovery-scenario (有机半导体主动学习发现)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 有机半导体主动学习发现
- 关联论文: Active discovery of organic semiconductors | doi:
