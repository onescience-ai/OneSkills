...
## 实例任务（本骨架在各场景的实例化）
- matchem-defect-model-and-control-hbn-single-photon-emission-inst
- matchem-defect-model-and-control-lithium-reduction-room-inst
- matchem-defect-model-and-control-mos2-monolayer-atomic-inst
- matchem-defect-model-and-control-phosphorene-monolayer-inst
