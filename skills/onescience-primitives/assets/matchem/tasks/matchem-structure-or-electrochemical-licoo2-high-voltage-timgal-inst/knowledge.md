# 实例任务：结构或电化学响应获取 @ LiCoO2高电压TiMgAl协同掺杂优化

- domain: matchem
- 骨架: matchem-structure-or-electrochemical-response-acquisition-task
- 场景: matchem-licoo2-high-voltage-timgal-co-doping-optimization-scenario (LiCoO2高电压TiMgAl协同掺杂优化)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- LiCoO2高电压TiMgAl协同掺杂优化
- 关联论文: Trace doping of multiple elements enables stable battery cycling of LiCoO2 at 4.6 V | doi:
