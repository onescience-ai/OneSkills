# 实例任务：根源模型训练与适用域评估 @ 钙钛矿结晶机器学习加速优化

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-perovskite-crystallization-machine-learning-accelerated-scenario (钙钛矿结晶机器学习加速优化)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 钙钛矿结晶机器学习加速优化
- 关联论文: Machine-Learning-Accelerated Perovskite Crystallization | doi:
