# 实例任务：根源模型训练与适用域评估 @ 高熵陶瓷机器学习发现

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-high-entropy-ceramic-ml-discovery-scenario (高熵陶瓷机器学习发现)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 高熵陶瓷机器学习发现
- 关联论文: Discovery of high-entropy ceramics via machine learning | doi:
