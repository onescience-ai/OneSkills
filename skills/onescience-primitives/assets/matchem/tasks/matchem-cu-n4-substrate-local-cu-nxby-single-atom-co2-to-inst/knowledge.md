...
- domain: matchem
- 骨架: matchem-cu-n4-substrate-local-coordination-geometry-generation-task
- 场景: matchem-cu-nxby-single-atom-co2-to-ch4-selectivity-optimization-scenario (Cu-NxBy_单原子位点CO2到CH4选择性优化)
- step_id: s01
- depend: []
