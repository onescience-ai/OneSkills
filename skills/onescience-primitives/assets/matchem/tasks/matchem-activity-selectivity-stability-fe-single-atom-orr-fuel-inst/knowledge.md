# 实例任务：活性选择性稳定性联评 @ Fe单原子氧还原燃料电池催化剂设计

- domain: matchem
- 骨架: matchem-activity-selectivity-stability-joint-evaluation-task
- 场景: matchem-fe-single-atom-orr-fuel-cell-catalyst-design-scenario (Fe单原子氧还原燃料电池催化剂设计)
- step_id: s03
- depend: ['s02']

## 场景研究主体
- Fe单原子氧还原燃料电池催化剂设计
- 关联论文: Enhanced oxygen reduction with single-atomic-site iron catalysts for a zinc-air battery and hydrogen-air fuel cell | doi:
