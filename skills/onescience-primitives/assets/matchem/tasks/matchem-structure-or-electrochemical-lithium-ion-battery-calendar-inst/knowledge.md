# 实例任务：结构或电化学响应获取 @ 锂离子电池日历老化预测

- domain: matchem
- 骨架: matchem-structure-or-electrochemical-response-acquisition-task
- 场景: matchem-lithium-ion-battery-calendar-aging-prediction-scenario (锂离子电池日历老化预测)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 锂离子电池日历老化预测
- 关联论文: Battery calendar aging and machine learning | doi:
