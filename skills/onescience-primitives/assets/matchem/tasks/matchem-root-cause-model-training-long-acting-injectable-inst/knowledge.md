# 实例任务：根源模型训练与适用域评估 @ 长效注射聚合物配方机器学习优化

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-long-acting-injectable-polymer-formulation-machine-learning-scenario (长效注射聚合物配方机器学习优化)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 长效注射聚合物配方机器学习优化
- 关联论文: Machine learning models to accelerate the design of polymeric long-acting injectables | doi:
