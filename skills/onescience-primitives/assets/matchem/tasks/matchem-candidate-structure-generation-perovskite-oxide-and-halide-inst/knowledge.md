# 实例任务：候选结构生成与去重 @ 钙钛矿氧化物与卤化物容忍因子稳定性筛选

- domain: matchem
- 骨架: matchem-candidate-structure-generation-deduplication-task
- 场景: matchem-perovskite-oxide-and-halide-tolerance-factor-stability-screening-scenario (钙钛矿氧化物与卤化物容忍因子稳定性筛选)
- step_id: s02
- depend: ['s01']
