# 实例任务：结构与分离目标定义 @ 二胺接枝MOF协同CO2捕集设计

- domain: matchem
- 骨架: matchem-structure-and-separation-target-definition-task
- 场景: matchem-diamine-grafted-mof-co2-capture-design-scenario (二胺接枝MOF协同CO2捕集设计)
- step_id: s01
- depend: []

## 场景研究主体
- 二胺接枝MOF协同CO2捕集设计
- 关联论文: Cooperative insertion of CO2 in diamine-appended metal-organic frameworks | doi:
