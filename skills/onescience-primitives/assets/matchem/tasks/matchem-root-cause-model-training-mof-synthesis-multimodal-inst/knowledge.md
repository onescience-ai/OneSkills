# 实例任务：根源模型训练与适用域评估 @ MOF合成应用多模态机器学习关联

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-mof-synthesis-multimodal-machine-learning-correlation-scenario (MOF合成应用多模态机器学习关联)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- MOF合成应用多模态机器学习关联
- 关联论文: Connecting metal-organic framework synthesis to applications using multimodal machine learning | doi:
