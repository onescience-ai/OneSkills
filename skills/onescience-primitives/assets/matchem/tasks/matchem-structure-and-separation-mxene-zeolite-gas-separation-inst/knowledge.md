# 实例任务：结构与分离目标定义 @ MXene分子筛气体分离膜设计

- domain: matchem
- 骨架: matchem-structure-and-separation-target-definition-task
- 场景: matchem-mxene-zeolite-gas-separation-membrane-design-scenario (MXene分子筛气体分离膜设计)
- step_id: s01
- depend: []

## 场景研究主体
- MXene分子筛气体分离膜设计
- 关联论文: MXene molecular sieving membranes for highly efficient gas separation | doi:
