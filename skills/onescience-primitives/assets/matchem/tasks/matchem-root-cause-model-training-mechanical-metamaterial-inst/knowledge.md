# 实例任务：根源模型训练与适用域评估 @ 力学超材料目标响应逆向设计

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-mechanical-metamaterial-target-response-inverse-design-scenario (力学超材料目标响应逆向设计)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 力学超材料目标响应逆向设计
- 关联论文: Rapid inverse design of metamaterials based on prescribed mechanical behavior through machine learning | doi:
