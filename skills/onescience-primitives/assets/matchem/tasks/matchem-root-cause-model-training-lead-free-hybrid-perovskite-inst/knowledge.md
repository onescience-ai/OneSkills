# 实例任务：根源模型训练与适用域评估 @ 无铅杂化钙钛矿稳定性机器学习筛选

- domain: matchem
- 骨架: matchem-root-cause-model-training-applicability-domain-assessment-task
- 场景: matchem-lead-free-hybrid-perovskite-stability-ml-screening-scenario (无铅杂化钙钛矿稳定性机器学习筛选)
- step_id: s02
- depend: ['s01']

## 场景研究主体
- 无铅杂化钙钛矿稳定性机器学习筛选
- 关联论文: Accelerated discovery of stable lead-free hybrid organic-inorganic perovskites via machine learning | doi:
