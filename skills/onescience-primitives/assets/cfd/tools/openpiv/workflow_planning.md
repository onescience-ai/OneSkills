...
Use this primitive when the task explicitly involves `openpiv`, its scientific workflow, or its associated artifacts and data structures.
...
Pass `primitive_id: cfd.tools.openpiv`, source references used, package/version assumptions, input artifacts, output expectations, and unresolved validation risks to the next workflow step.
