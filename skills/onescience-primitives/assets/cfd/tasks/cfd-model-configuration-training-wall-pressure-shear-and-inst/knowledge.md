# 实例任务：模型配置与训练 @ CFD_S014

- domain: cfd
- 骨架: cfd-model-configuration-training-task
- 场景: cfd-wall-pressure-shear-and-integral-aerodynamic-force-joint-scenario (CFD_S014)
- step_id: s03
- depend: ['s02']
...
## 本实例输入槽
- {MODEL_NAME} | required=True | type=str | var_name=模型名称 | hint=实现或模型注册名 | default=CNN、Aerodynamic foundation model
