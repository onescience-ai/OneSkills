...
## 实例任务（本骨架在各场景的实例化）
- cfd-closed-loop-strategy-deploymen-data-driven-wind-field-inst
- cfd-closed-loop-strategy-deploymen-deep-reinforcement-learning-inst
- cfd-closed-loop-strategy-deploymen-deep-rl-bluff-body-wake-inst
- cfd-closed-loop-strategy-deploymen-differentiable-and-generativ-inst
- cfd-closed-loop-strategy-deploymen-wing-gust-transonic-flow-inst
