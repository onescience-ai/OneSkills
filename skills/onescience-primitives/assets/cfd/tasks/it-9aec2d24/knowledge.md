# 实例任务：模型配置与训练 @ CFD_S088

- domain: cfd
- 骨架: tk-cfd-18078463
- 场景: sc-887b3887 (CFD_S088)
- step_id: s03
- depend: ['s02']
...
## 本实例输入槽
- {MODEL_NAME} | required=True | type=str | var_name=模型名称 | hint=实现或模型注册名 | default=Implicit neural representation、Continuous ROM
