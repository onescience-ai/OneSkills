...
## 实例任务（本骨架在各场景的实例化）
- cfd-probabilistic-reasoning-bayesian-multi-fidelity-inst
- cfd-probabilistic-reasoning-out-of-distribution-flow-inst
- cfd-probabilistic-reasoning-physics-informed-probabilist-inst
