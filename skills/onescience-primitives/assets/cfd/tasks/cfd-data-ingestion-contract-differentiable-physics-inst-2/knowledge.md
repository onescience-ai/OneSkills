# 实例任务：数据接入与契约核验 @ CFD_S071

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-differentiable-physics-solver-and-equation-structure-learning-scenario (CFD_S071)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=可微数值轨迹与算子数据
