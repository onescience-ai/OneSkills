# 实例任务：数据接入与契约核验 @ CFD_S086

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-pod-modal-decomposition-flow-reduced-order-modeling-scenario (CFD_S086)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=CFD快照矩阵与参数标签
