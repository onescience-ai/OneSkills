# 实例任务：数据接入与契约核验 @ CFD_S030

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-learned-mesh-movement-adaptive-fem-optimization-scenario (CFD_S030)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=自适应有限元网格误差数据
