# 实例任务：数据接入与契约核验 @ CFD_S026

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-convective-scalar-mixed-turbulent-heat-flux-prediction-scenario (CFD_S026)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=Rayleigh-Benard对流与标量混合数据
