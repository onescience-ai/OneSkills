# 实例任务：数据接入与契约核验 @ CFD_S012

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-multi-scale-transformer-vehicle-high-resolution-aerodynamic-scenario (CFD_S012)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=三维汽车表面与体流场数据
