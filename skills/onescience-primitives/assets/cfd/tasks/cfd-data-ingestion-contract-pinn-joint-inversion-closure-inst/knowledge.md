# 实例任务：数据接入与契约核验 @ CFD_S075

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-pinn-joint-inversion-closure-mean-flow-scenario (CFD_S075)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=稀疏实验观测与RANS方程数据
