# 实例任务：模型配置与训练 @ CFD_S079

- domain: cfd
- 骨架: cfd-model-configuration-training-task
- 场景: cfd-stochastic-differential-and-probabilistic-coarse-graining-scenario (CFD_S079)
- step_id: s03
- depend: ['s02']
...
## 本实例输入槽
- {MODEL_NAME} | required=True | type=str | var_name=模型名称 | hint=实现或模型注册名 | default=Neural SDE closure、Probabilistic coarse-graining model
