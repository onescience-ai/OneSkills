# 实例任务：数据接入与契约核验 @ CFD_S083

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-wing-gust-transonic-flow-active-control-scenario (CFD_S083)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=翼型压力阵风载荷与控制器数据
