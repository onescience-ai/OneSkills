# 实例任务：数据接入与契约核验 @ CFD_S042

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-spectral-enhanced-pinn-high-frequency-multi-scale-pde-solving-scenario (CFD_S042)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=高频与多尺度PDE配点
