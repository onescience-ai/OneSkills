# 实例任务：数据接入与契约核验 @ CFD_S016

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-physics-informed-probabilistic-network-flow-field-uncertainty-scenario (CFD_S016)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=稀疏观测与CFD先验联合数据
