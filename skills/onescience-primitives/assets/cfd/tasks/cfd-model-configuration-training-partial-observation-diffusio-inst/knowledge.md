...
## 本实例输入槽
- {MODEL_NAME} | required=True | type=str | var_name=模型名称 | hint=实现或模型注册名 | default=Score-based data assimilation、Diffusion PDE model、Neural fluid field
