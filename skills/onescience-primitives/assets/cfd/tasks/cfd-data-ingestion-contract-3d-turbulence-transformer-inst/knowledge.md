# 实例任务：数据接入与契约核验 @ CFD_S024

- domain: cfd
- 骨架: cfd-data-ingestion-contract-validation-task
- 场景: cfd-3d-turbulence-transformer-multiscale-spatiotemporal-forecast-scenario (CFD_S024)
- step_id: s01
- depend: []
...
- {DATASET_NAME} | required=True | type=str | var_name=数据集名称 | hint=来源与数据版本 | default=三维DNS与LES体湍流数据
