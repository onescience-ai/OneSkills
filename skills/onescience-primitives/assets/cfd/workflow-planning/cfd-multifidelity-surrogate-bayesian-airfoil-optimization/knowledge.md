...
- 需要在低计算成本下探索高维设计空间，同时保证物理一致性
- 域外工况需要经CFD复核确认模型泛化能力
...
| 参数 | 值 | 来源 | 说明 |
|------|-----|------|------|
| 多保真建模方法 | Multi-fidelity surrogate | [场景JSON] | 利用高低保真数据构建代理模型 |
| 优化策略 | Bayesian optimizer | [场景JSON] | 基于代理模型的全局优化搜索 |
...
- `cfd-multifidelity-airfoil-acceptance-applicability-domain`：验收与适用域判定卡

## 证据来源

[1] "Surrogate-Based Aerodynamic Shape Optimization in Multiscale Flows via the Implicit Unified Gas-Kinetic Scheme", arXiv:2606.00645, 2025
[2] "Multi-Timescale Dynamics Model Bayesian Optimization for Plasma Stabilization in Tokamaks", 2026
[3] "Optimization-Embedded Active Multi-Fidelity Surrogate Learning for Multi-Condition Airfoil Shape Optimization", arXiv:2603.17057, 2026
[4] "ShapeBench: A Scalable Benchmark and Diagnostic Suite for Standardized Evaluation in Aerodynamic Shape Optimization", arXiv:2605.20763, 2025
