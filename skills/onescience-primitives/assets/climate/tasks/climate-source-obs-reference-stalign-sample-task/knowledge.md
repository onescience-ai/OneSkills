...
## 实例任务（本骨架在各场景的实例化）
- climate-source-obs-reference-stalign-geostationary-meteorological-inst
- climate-source-obs-reference-stalign-ground-meteorological-inst
- climate-source-obs-reference-stalign-lidar-sounding-fusion-inst
- climate-source-obs-reference-stalign-multi-element-analysis-inst
- climate-source-obs-reference-stalign-radar-satellite-rain-gauge-inst
- climate-source-obs-reference-stalign-weather-radar-volume-scan-inst
