...
## 实例任务（本骨架在各场景的实例化）
- climate-hazard-factor-event-label-climate-fuel-anomaly-driven-inst
- climate-hazard-factor-event-label-dry-snow-avalanche-danger-inst
- climate-hazard-factor-event-label-multi-source-observation-inst
- climate-hazard-factor-event-label-multi-time-window-rainfall-inst
- climate-hazard-factor-event-label-satellite-and-ground-sensor-inst
- climate-hazard-factor-event-label-terrain-and-underlying-inst
- climate-hazard-factor-event-label-tsunami-geodetic-observation-inst
- climate-hazard-factor-event-label-typhoon-and-pressure-wind-inst
- climate-hazard-factor-event-label-weather-driven-next-day-inst
