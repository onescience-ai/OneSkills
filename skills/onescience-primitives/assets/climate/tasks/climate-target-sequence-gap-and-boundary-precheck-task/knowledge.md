...
## 实例任务（本骨架在各场景的实例化）
- climate-target-sequence-gap-and-avhrr-modis-continuous-ndvi-inst
- climate-target-sequence-gap-and-cloud-covered-satellite-sst-inst
- climate-target-sequence-gap-and-global-ocean-pco2-sparse-inst
- climate-target-sequence-gap-and-grace-gap-terrestrial-water-inst
