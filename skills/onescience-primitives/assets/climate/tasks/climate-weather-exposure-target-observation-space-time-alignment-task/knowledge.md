...
## 实例任务（本骨架在各场景的实例化）
- climate-weather-exposure-target-cultivar-location-uncertain-inst-2
- climate-weather-exposure-target-growing-season-county-corn-inst-2
- climate-weather-exposure-target-weather-and-population-inst-2
- climate-weather-exposure-target-weather-driven-weekly-inst-2
