...
## 实例任务（本骨架在各场景的实例化）
- climate-multi-resolution-data-china-0-05-historical-inst
- climate-multi-resolution-data-cmip6-temperature-precipitat-inst
- climate-multi-resolution-data-coarse-grid-atmospheric-inst
- climate-multi-resolution-data-coarse-resolution-precipitat-inst
- climate-multi-resolution-data-complex-terrain-region-100m-inst
- climate-multi-resolution-data-mountain-snow-water-equivale-inst
- climate-multi-resolution-data-nwp-24-240h-near-surface-inst
