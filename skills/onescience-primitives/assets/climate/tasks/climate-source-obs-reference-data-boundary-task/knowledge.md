...
## 实例任务（本骨架在各场景的实例化）
- climate-source-obs-reference-data-geostationary-meteorological-inst
- climate-source-obs-reference-data-ground-meteorological-inst
- climate-source-obs-reference-data-lidar-sounding-fusion-inst
- climate-source-obs-reference-data-multi-element-analysis-inst
- climate-source-obs-reference-data-radar-satellite-rain-gauge-inst
- climate-source-obs-reference-data-weather-radar-volume-scan-inst
