...
- datasets/nasa-power-rainfall-dataset
...
## 实例任务（本骨架在各场景的实例化）
- climate-weather-energy-operational-complex-terrain-wind-farm-inst
- climate-weather-energy-operational-multi-station-solar-farm-inst
- climate-weather-energy-operational-sky-camera-satellite-solar-inst
- climate-weather-energy-operational-weather-sensitive-urban-inst
