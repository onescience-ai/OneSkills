...
## 实例任务（本骨架在各场景的实例化）
- climate-ocean-state-forcing-stalign-arctic-sea-ice-jantojune-inst
- climate-ocean-state-forcing-stalign-coastal-bathymetry-reconstru-inst
- climate-ocean-state-forcing-stalign-global-eddy-resolving-3d-inst
- climate-ocean-state-forcing-stalign-global-sst-subseasonal-inst
- climate-ocean-state-forcing-stalign-nearshore-significant-wave-inst
- climate-ocean-state-forcing-stalign-regional-sst-1to7day-daily-inst
