...
## 实例任务（本骨架在各场景的实例化）
- climate-ocean-state-forcing-data-arctic-sea-ice-jantojune-inst
- climate-ocean-state-forcing-data-coastal-bathymetry-reconstru-inst
- climate-ocean-state-forcing-data-global-eddy-resolving-3d-inst
- climate-ocean-state-forcing-data-global-sst-subseasonal-inst
- climate-ocean-state-forcing-data-nearshore-significant-wave-inst
- climate-ocean-state-forcing-data-regional-sst-1to7day-daily-inst
