...
Use this primitive when the task explicitly involves `clinical-decision-support`, its scientific workflow, or its associated artifacts and data structures.
...
Pass `primitive_id: general.application.clinical_decision_support`, source references used, package/version assumptions, input artifacts, output expectations, and unresolved validation risks to the next workflow step.
