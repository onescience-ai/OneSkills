...
Use this primitive when the task explicitly involves `peer-review`, its scientific workflow, or its associated artifacts and data structures.
...
Pass `primitive_id: general.workflow-planning.peer_review`, source references used, package/version assumptions, input artifacts, output expectations, and unresolved validation risks to the next workflow step.
