...
Use this primitive when the task explicitly involves `analytical-method-validation`, its scientific workflow, or its associated artifacts and data structures.
...
Pass `primitive_id: general.workflow-planning.analytical_method_validation`, source references used, package/version assumptions, input artifacts, output expectations, and unresolved validation risks to the next workflow step.
