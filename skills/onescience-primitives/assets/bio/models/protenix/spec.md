...
Protenix 是 AF3-style 多分子结构预测模型原语，核心定位是统一处理蛋白、核酸、配体、离子等复杂体系；它以 token/pair/atom feature dict 为中心，结合 Pairformer 和 diffusion module 输出多样本坐标与置信度。
...
- `{onescience_path}/onescience/examples/biosciences/protenix/README.md`
