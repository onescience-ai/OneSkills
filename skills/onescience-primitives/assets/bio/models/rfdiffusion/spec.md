...
RFdiffusion 是蛋白质骨架扩散生成原语，核心功能是在 contig、motif、binder hotspot、symmetry 或 partial diffusion 条件下生成新骨架；它输出的是骨架设计结果，通常需要后接 ProteinMPNN 进行序列设计和结构验证。
...
- `{onescience_path}/onescience/examples/biosciences/RFdiffusion/RFdiffusion_README.md`
- `{onescience_path}/onescience/examples/biosciences/RFdiffusion/config/inference/base.yaml`
