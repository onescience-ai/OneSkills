...
## 实例任务（本骨架在各场景的实例化）
- bio-microorganism-prediction-contrastive-learning-driven-inst
- bio-microorganism-prediction-cross-species-antimicrobial-inst
- bio-microorganism-prediction-dna-sequence-driven-microbia-inst
- bio-microorganism-prediction-function-guided-metageneome-inst
- bio-microorganism-prediction-pathogen-monitoring-metageno-inst
- bio-microorganism-prediction-phage-and-prokaryotic-host-inst
- bio-microorganism-prediction-phage-lifestyle-classificati-inst
