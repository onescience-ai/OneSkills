...
- domain: bio
- 骨架: bio-sequence-window-model-preparation-task
- 场景: bio-genomic-language-model-transcription-factor-causal-decomposition-scenario (B66)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=causal_dictionary.pt
