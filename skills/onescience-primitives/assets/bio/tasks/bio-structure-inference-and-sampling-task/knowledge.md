...
## 实例任务（本骨架在各场景的实例化）
- bio-structure-inference-and-atom-level-protein-represent-inst
- bio-structure-inference-and-lightweight-multi-molecular-inst
- bio-structure-inference-and-msa-free-protein-fast-inst
- bio-structure-inference-and-openfold-component-ablation-inst
- bio-structure-inference-and-physical-feedback-constraine-inst
- bio-structure-inference-and-protein-complex-structure-inst
- bio-structure-inference-and-protein-ligand-complex-inst
- bio-structure-inference-and-protein-monomer-structure-inst
- bio-structure-inference-and-protein-multi-conformational-inst
- bio-structure-inference-and-protein-nucleic-acid-ligand-inst
