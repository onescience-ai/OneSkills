...
## 实例任务（本骨架在各场景的实例化）
- bio-medical-reasoning-consistency-clinical-reward-aligned-inst
- bio-medical-reasoning-consistency-longitudinal-chest-ct-inst
- bio-medical-reasoning-consistency-medical-text-and-image-inst
