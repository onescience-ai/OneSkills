...
## 实例任务（本骨架在各场景的实例化）
- bio-genome-input-coordinate-bidirectional-equivariant-inst
- bio-genome-input-coordinate-cell-type-specific-regulator-inst
- bio-genome-input-coordinate-dna-language-model-biologica-inst
- bio-genome-input-coordinate-genomic-language-model-inst
- bio-genome-input-coordinate-histone-modification-driven-inst
- bio-genome-input-coordinate-long-dna-interval-multi-inst
- bio-genome-input-coordinate-million-base-context-genome-inst
- bio-genome-input-coordinate-multi-species-dna-sequence-inst
- bio-genome-input-coordinate-rice-breeding-variant-inst
- bio-genome-input-coordinate-simplex-flow-matching-inst
