...
- 场景: bio-reaction-condition-driven-de-novo-enzyme-design-scenario (B20)
- step_id: s01
- depend: []

## 场景研究主体
- B20
- 关联论文: Reaction-conditioned De Novo Enzyme Design with GENzyme | doi:
...
## 本实例输入槽
- {DESIGN_INPUT} | required=True | type=doc | var_name=设计输入 | hint=输入结构或约束文件 | default=reaction_smiles.csv
- {MODEL_NAME} | required=True | type=enum | var_name=设计模型 | hint=选择场景使用的模型 | default=GENzyme
