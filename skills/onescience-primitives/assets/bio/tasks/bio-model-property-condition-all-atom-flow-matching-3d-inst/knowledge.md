...
- 场景: bio-all-atom-flow-matching-3d-small-molecule-generation-scenario (B59)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=flowmol3.ckpt
