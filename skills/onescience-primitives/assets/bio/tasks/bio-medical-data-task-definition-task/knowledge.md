...
## 实例任务（本骨架在各场景的实例化）
- bio-medical-data-task-definition-clinical-reward-aligned-inst
- bio-medical-data-task-definition-longitudinal-chest-ct-inst
- bio-medical-data-task-definition-medical-text-and-image-inst
