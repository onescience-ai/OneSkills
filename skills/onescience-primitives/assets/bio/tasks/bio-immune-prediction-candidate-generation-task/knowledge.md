...
## 实例任务（本骨架在各场景的实例化）
- bio-immune-prediction-candidate-affinity-optimized-structure-inst
- bio-immune-prediction-candidate-antibody-antigen-binding-inst
- bio-immune-prediction-candidate-antigen-conditioned-full-inst
- bio-immune-prediction-candidate-antigen-specific-multimodal-inst
- bio-immune-prediction-candidate-cd4-t-cell-epitope-processin-inst
- bio-immune-prediction-candidate-cdr-loop-antibody-scaffold-inst
- bio-immune-prediction-candidate-interpretable-tcr-epitope-inst
- bio-immune-prediction-candidate-reinforcement-learning-inst
- bio-immune-prediction-candidate-sars-cov-2-antibody-binding-inst
- bio-immune-prediction-candidate-structure-retrieval-augmente-inst
