...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=simplefold.ckpt
- {MSA_MODE} | required=False | type=enum | var_name=MSA模式 | hint=选择MSA准备方式 | default=single_sequence
