...
- 场景: bio-reinforcement-learning-guided-antibody-affinity-maturation-scenario (B23)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=betterbodies.ckpt
