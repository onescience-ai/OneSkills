...
## 实例任务（本骨架在各场景的实例化）
- bio-biological-consistency-and-causal-latent-diffusion-inst
- bio-biological-consistency-and-cross-cell-type-and-dose-inst
- bio-biological-consistency-and-geneformer-scgpt-single-inst
- bio-biological-consistency-and-mcmc-guided-multi-omics-inst
- bio-biological-consistency-and-multimodal-reasoning-enhance-inst
- bio-biological-consistency-and-scgpt-hematopoietic-cell-inst
- bio-biological-consistency-and-single-cell-chromatin-inst
- bio-biological-consistency-and-single-cell-to-spatial-inst
- bio-biological-consistency-and-spatial-transcriptomics-and-inst
- bio-biological-consistency-and-spatial-transcriptomics-inst
