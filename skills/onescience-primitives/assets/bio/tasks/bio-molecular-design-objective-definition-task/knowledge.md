...
## 实例任务（本骨架在各场景的实例化）
- bio-molecular-design-objective-1d-language-3d-diffusion-inst
- bio-molecular-design-objective-affinity-gradient-guided-inst
- bio-molecular-design-objective-all-atom-flow-matching-3d-inst
- bio-molecular-design-objective-best-of-k-aligned-target-inst
- bio-molecular-design-objective-molecular-latent-space-inst
- bio-molecular-design-objective-multi-task-target-aware-3d-inst
- bio-molecular-design-objective-positive-negative-activity-inst
- bio-molecular-design-objective-shape-electrostatic-pharmaco-inst
- bio-molecular-design-objective-smiles-foundation-model-adm-inst
- bio-molecular-design-objective-synthesis-route-constrained-inst
