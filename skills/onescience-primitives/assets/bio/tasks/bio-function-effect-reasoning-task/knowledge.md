...
## 实例任务（本骨架在各场景的实例化）
- bio-function-effect-reasoning-deep-mutational-scanning-inst
- bio-function-effect-reasoning-enzyme-classification-and-inst
- bio-function-effect-reasoning-enzyme-sequence-and-substrat-inst
- bio-function-effect-reasoning-equivariant-structural-inst
- bio-function-effect-reasoning-evolutionary-spectrum-inst
- bio-function-effect-reasoning-few-shot-multimodal-protein-inst
- bio-function-effect-reasoning-multi-scale-representation-inst
- bio-function-effect-reasoning-preference-optimization-inst
- bio-function-effect-reasoning-protein-mutation-effect-inst
- bio-function-effect-reasoning-residual-based-interpretable-inst
