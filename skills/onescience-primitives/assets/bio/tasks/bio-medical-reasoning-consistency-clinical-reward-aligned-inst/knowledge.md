...
- domain: bio
- 骨架: bio-medical-reasoning-consistency-review-task
- 场景: bio-clinical-reward-aligned-chest-xray-report-generation-scenario (B99)
- step_id: s03
- depend: ['s02']

## 场景研究主体
- B99
- 关联论文: DobicVLM: Aligning Chest X-Ray Report Generation with Clinically-Grounded Programmatic Rewards via Group Relative Policy Optimization | doi:
