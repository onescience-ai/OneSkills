...
## 实例任务（本骨架在各场景的实例化）
- bio-structure-prediction-or-bidirectional-anchored-inst
- bio-structure-prediction-or-deep-sequence-model-mirna-inst
- bio-structure-prediction-or-geometric-deep-learning-inst
- bio-structure-prediction-or-language-model-driven-rna-inst
- bio-structure-prediction-or-large-kernel-rna-secondary-inst
- bio-structure-prediction-or-linear-time-rna-secondary-inst
- bio-structure-prediction-or-low-data-rna-tertiary-inst
- bio-structure-prediction-or-protein-rna-complex-binding-inst
- bio-structure-prediction-or-rna-3d-target-structure-inst
- bio-structure-prediction-or-structure-sequence-encoded-inst
