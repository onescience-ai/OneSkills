...
## 实例任务（本骨架在各场景的实例化）
- bio-input-and-task-definition-atom-level-protein-represent-inst
- bio-input-and-task-definition-lightweight-multi-molecular-inst
- bio-input-and-task-definition-msa-free-protein-fast-inst
- bio-input-and-task-definition-openfold-component-ablation-inst
- bio-input-and-task-definition-physical-feedback-constraine-inst
- bio-input-and-task-definition-protein-complex-structure-inst
- bio-input-and-task-definition-protein-ligand-complex-inst
- bio-input-and-task-definition-protein-monomer-structure-inst
- bio-input-and-task-definition-protein-multi-conformational-inst
- bio-input-and-task-definition-protein-nucleic-acid-ligand-inst
