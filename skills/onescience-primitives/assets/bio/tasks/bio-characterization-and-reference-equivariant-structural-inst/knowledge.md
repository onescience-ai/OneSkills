...
- 场景: bio-equivariant-structural-network-mutation-stability-prediction-scenario (B34)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=hermes.pt
