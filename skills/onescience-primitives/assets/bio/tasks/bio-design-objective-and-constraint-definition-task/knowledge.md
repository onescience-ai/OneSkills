...
## 实例任务（本骨架在各场景的实例化）
- bio-design-objective-and-constrain-all-atom-protein-structure-inst
- bio-design-objective-and-constrain-functional-site-constrained-inst
- bio-design-objective-and-constrain-given-protein-backbone-inst
- bio-design-objective-and-constrain-multi-conformation-state-inst
- bio-design-objective-and-constrain-multi-functional-motif-inst
- bio-design-objective-and-constrain-protoken-latent-protein-inst
- bio-design-objective-and-constrain-reaction-condition-driven-inst
- bio-design-objective-and-constrain-substrate-pocket-constrained-inst
- bio-design-objective-and-constrain-target-specific-all-atom-inst
- bio-design-objective-and-constrain-transmembrane-protein-inst
