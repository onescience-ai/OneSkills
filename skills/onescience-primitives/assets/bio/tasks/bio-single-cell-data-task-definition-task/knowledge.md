...
## 实例任务（本骨架在各场景的实例化）
- bio-single-cell-data-task-causal-latent-diffusion-inst
- bio-single-cell-data-task-cross-cell-type-and-dose-inst
- bio-single-cell-data-task-geneformer-scgpt-single-inst
- bio-single-cell-data-task-mcmc-guided-multi-omics-inst
- bio-single-cell-data-task-multimodal-reasoning-enhance-inst
- bio-single-cell-data-task-scgpt-hematopoietic-cell-inst
- bio-single-cell-data-task-single-cell-chromatin-inst
- bio-single-cell-data-task-single-cell-to-spatial-inst
- bio-single-cell-data-task-spatial-transcriptomics-and-inst
- bio-single-cell-data-task-spatial-transcriptomics-inst
