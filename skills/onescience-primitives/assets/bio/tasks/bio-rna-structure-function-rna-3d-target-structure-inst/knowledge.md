...
- 场景: bio-rna-3d-target-structure-swarm-inverse-folding-scenario (B83)
- step_id: s04
- depend: ['s03']

## 场景研究主体
- B83
- 关联论文: BeeRNA: tertiary structure-based RNA inverse folding using Artificial Bee Colony | doi:; GoForth: Language Models for RNA Design under Structure, Sequence, and Coding Constraints | doi:
