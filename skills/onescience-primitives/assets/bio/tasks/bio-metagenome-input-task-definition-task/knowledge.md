...
## 实例任务（本骨架在各场景的实例化）
- bio-metagenome-input-task-contrastive-learning-driven-inst
- bio-metagenome-input-task-cross-species-antimicrobial-inst
- bio-metagenome-input-task-dna-sequence-driven-microbia-inst
- bio-metagenome-input-task-function-guided-metageneome-inst
- bio-metagenome-input-task-pathogen-monitoring-metageno-inst
- bio-metagenome-input-task-phage-and-prokaryotic-host-inst
- bio-metagenome-input-task-phage-lifestyle-classificati-inst
