...
- 场景: bio-atom-level-protein-representation-driven-structure-prediction-scenario (B08)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=atom_repr.ckpt
