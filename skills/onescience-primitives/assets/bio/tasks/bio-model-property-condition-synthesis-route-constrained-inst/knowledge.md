...
- 场景: bio-synthesis-route-constrained-gflownet-molecule-generation-scenario (B58)
- step_id: s02
- depend: ['s01']
...
## 本实例输入槽
- {CHECKPOINT} | required=True | type=doc | var_name=模型权重 | hint=模型权重名称 | default=rgfn.pt
