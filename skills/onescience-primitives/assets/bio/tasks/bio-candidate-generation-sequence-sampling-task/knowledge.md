...
## 实例任务（本骨架在各场景的实例化）
- bio-candidate-generation-sequence-all-atom-protein-structure-inst
- bio-candidate-generation-sequence-functional-site-constrained-inst
- bio-candidate-generation-sequence-given-protein-backbone-inst
- bio-candidate-generation-sequence-multi-conformation-state-inst
- bio-candidate-generation-sequence-multi-functional-motif-inst
- bio-candidate-generation-sequence-protoken-latent-protein-inst
- bio-candidate-generation-sequence-reaction-condition-driven-inst
- bio-candidate-generation-sequence-substrate-pocket-constrained-inst
- bio-candidate-generation-sequence-target-specific-all-atom-inst
- bio-candidate-generation-sequence-transmembrane-protein-inst
