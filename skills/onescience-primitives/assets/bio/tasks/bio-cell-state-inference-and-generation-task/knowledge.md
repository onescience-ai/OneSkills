...
## 实例任务（本骨架在各场景的实例化）
- bio-cell-state-inference-and-causal-latent-diffusion-inst
- bio-cell-state-inference-and-cross-cell-type-and-dose-inst
- bio-cell-state-inference-and-geneformer-scgpt-single-inst
- bio-cell-state-inference-and-mcmc-guided-multi-omics-inst
- bio-cell-state-inference-and-multimodal-reasoning-enhance-inst
- bio-cell-state-inference-and-scgpt-hematopoietic-cell-inst
- bio-cell-state-inference-and-single-cell-chromatin-inst
- bio-cell-state-inference-and-single-cell-to-spatial-inst
- bio-cell-state-inference-and-spatial-transcriptomics-and-inst
- bio-cell-state-inference-and-spatial-transcriptomics-inst
