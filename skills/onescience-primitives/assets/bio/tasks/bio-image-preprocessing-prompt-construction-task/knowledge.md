...
## 实例任务（本骨架在各场景的实例化）
- bio-image-preprocessing-prompt-clinical-reward-aligned-inst
- bio-image-preprocessing-prompt-longitudinal-chest-ct-inst
- bio-image-preprocessing-prompt-medical-text-and-image-inst
