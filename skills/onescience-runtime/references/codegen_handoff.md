...
本文件定义 `onescience-runtime.discover -> onescience-coder` 的最小交接面。
...
`onescience-runtime` 的 discover 阶段负责识别：
...
- `node_scope`: `single_node` / `multi_node`
...
## `onescience-runtime.discover` 应该怎么输出
